...
public class TowerConfig
{
    ...
    public static Dictionary<string, List<TowerData>> s_Towers = new Dictionary<string, List<TowerData>>()
    {
        ...
        {TowerTypeTags.DRUM_TOWER, new List<TowerData>()
        {
            ...
            new TowerData(TowerTypeTags.DRUM_TOWER, 2, 3, 300, 0, 375, 5f, 8f,0.3f),
            new TowerData(TowerTypeTags.DRUM_TOWER, 3, 3, 0, 0 , 600, 7f, 10f, 0.25f)
        }},
        {TowerTypeTags.LEAD_TOWER, new List<TowerData>()
        {  
            new TowerData(TowerTypeTags.LEAD_TOWER, 1, 3, 200, 200, 150, 0.75f, 3.25f, 0.025f),
            new TowerData(TowerTypeTags.LEAD_TOWER, 2, 3, 300, 0, 300, 1.25f, 3.5f, 0.025f),
            new TowerData(TowerTypeTags.LEAD_TOWER, 3, 3, 0, 0, 525, 2f, 3.75f, 0.025f)
        }}
    };
}//